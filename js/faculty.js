...
async function loadAllFaculty() {
    ...
    try {
        ...
        if (facultyDatabase.length > 0) {
            ...
            staff = [
                { name: 'Mr. Vipin Varshney', designation: 'Managing Director', subject: 'M.Ed, Ph.D', icon: 'fa-user-tie', qualification: 'Ph.D in Education, M.Ed', experience: '25 years', email: 'principal@acps.edu.in', remarks: 'Visionary leader with extensive experience in educational administration and curriculum development.', priority: 1 },
                { name: 'Mr. Anoop Agarwal', designation: 'Principal', subject: 'M.A. English', icon: 'fa-chalkboard-teacher', qualification: 'M.A. English Literature', experience: '20 years', email: 'director@acps.edu.in', remarks: 'Dedicated educator with a passion for English literature and student mentorship.', priority: 2 },
